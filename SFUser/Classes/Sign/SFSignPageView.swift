...
// MARK: - SFSignPageView
class SFSignPageView: SFScrollView {
    // MARK: block
    var pageDidChangedBlock: ((SFSignPageView, Int) -> ())?
    var forgetPwdBlock: (()->())? {
        didSet {
    ...
    // MARK: ui
    private lazy var codeView: SFCodeSignView = {
        return SFCodeSignView()
    }()
    
    private lazy var pwdView: SFPwdSignView = {
        return SFPwdSignView()
    }()
...
extension SFSignPageView: UIScrollViewDelegate {
