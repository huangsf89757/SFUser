...
// MARK: - SFSignVC
class SFSignVC: SFScrollViewController {
    // MARK: block
...
//            view.text = R.string.localizable.slogen() // FIXME
    ...
    private lazy var modeView: SFSignModeView = {
        return SFSignModeView().then { view in
    ...
    private lazy var pageView: SFSignPageView = {
        return SFSignPageView().then { view in
